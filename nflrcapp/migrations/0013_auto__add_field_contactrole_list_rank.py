...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactRole.list_rank'
        db.add_column(u'nflrcapp_contactrole', 'list_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactRole.list_rank'
        db.delete_column(u'nflrcapp_contactrole', 'list_rank')
