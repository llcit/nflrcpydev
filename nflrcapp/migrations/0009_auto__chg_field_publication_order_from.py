...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publication.order_from'
        db.alter_column(u'nflrcapp_publication', 'order_from', self.gf('django.db.models.fields.CharField')(max_length=250L))

    def backwards(self, orm):

        # Changing field 'Publication.order_from'
        db.alter_column(u'nflrcapp_publication', 'order_from', self.gf('django.db.models.fields.CharField')(max_length=10L))
