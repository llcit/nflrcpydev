...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.featured'
        db.add_column(u'nflrcapp_contact', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contact.featured_rank'
        db.add_column(u'nflrcapp_contact', 'featured_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.featured'
        db.delete_column(u'nflrcapp_contact', 'featured')

        # Deleting field 'Contact.featured_rank'
        db.delete_column(u'nflrcapp_contact', 'featured_rank')
    ...
    models = {
        ...
        u'nflrcapp.itemtag': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '180'})
        },
