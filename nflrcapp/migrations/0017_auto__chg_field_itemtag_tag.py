...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemTag.tag'
        db.alter_column(u'nflrcapp_itemtag', 'tag', self.gf('django.db.models.fields.CharField')(unique=True, max_length=180))

    def backwards(self, orm):

        # Changing field 'ItemTag.tag'
        db.alter_column(u'nflrcapp_itemtag', 'tag', self.gf('django.db.models.fields.CharField')(max_length=140, unique=True))
