...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nflrcapp_itemtag', 'tag', self.gf('django.db.models.fields.SlugField')(max_length=50))
        # Adding index on 'ItemTag', fields ['tag']
        db.create_index(u'nflrcapp_itemtag', ['tag'])


    def backwards(self, orm):
        # Removing index on 'ItemTag', fields ['tag']
        db.delete_index(u'nflrcapp_itemtag', ['tag'])


        # Changing field 'ItemTag.tag'
        db.alter_column(u'nflrcapp_itemtag', 'tag', self.gf('django.db.models.fields.CharField')(max_length=140))
