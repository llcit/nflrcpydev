...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.title'
        db.alter_column(u'nflrcapp_contact', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Contact.title'
        db.alter_column(u'nflrcapp_contact', 'title', self.gf('django.db.models.fields.CharField')(max_length=50L))
    ...
    models = {
        u'nflrcapp.contact': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '50', 'blank': 'True'}),
