...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.thumbnail_desc'
        db.add_column(u'nflrcapp_project', 'thumbnail_desc',
                      self.gf('django.db.models.fields.CharField')(default=u'more...', max_length=160, null=True),
                      keep_default=False)

        # Adding field 'Prodev.thumbnail_desc'
        db.add_column(u'nflrcapp_prodev', 'thumbnail_desc',
                      self.gf('django.db.models.fields.CharField')(default=u'more...', max_length=160, null=True),
                      keep_default=False)

        # Adding field 'Publication.thumbnail_desc'
        db.add_column(u'nflrcapp_publication', 'thumbnail_desc',
                      self.gf('django.db.models.fields.CharField')(default=u'more...', max_length=160, null=True),
                      keep_default=False)

        # Adding field 'StoryPage.thumbnail_desc'
        db.add_column(u'nflrcapp_storypage', 'thumbnail_desc',
                      self.gf('django.db.models.fields.CharField')(default='more...', max_length=160),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.thumbnail_desc'
        db.delete_column(u'nflrcapp_project', 'thumbnail_desc')

        # Deleting field 'Prodev.thumbnail_desc'
        db.delete_column(u'nflrcapp_prodev', 'thumbnail_desc')

        # Deleting field 'Publication.thumbnail_desc'
        db.delete_column(u'nflrcapp_publication', 'thumbnail_desc')

        # Deleting field 'StoryPage.thumbnail_desc'
        db.delete_column(u'nflrcapp_storypage', 'thumbnail_desc')
    ...
    models = {
        ...
        u'nflrcapp.prodev': {
            ...
            'thumbnail_desc': ('django.db.models.fields.CharField', [], {'default': "u'more...'", 'max_length': '160', 'null': 'True'}),
        ...
        u'nflrcapp.storypage': {
            ...
            'image': ('django.db.models.fields.CharField', [], {'max_length': '100L', 'blank': 'True'}),
            'skeywords': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'thumbnail_desc': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
