...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'TaggedItem.tag' to match new field type.
        db.rename_column(u'nflrcapp_taggeditem', 'tag', 'tag_id')
        # Changing field 'TaggedItem.tag'
        db.alter_column(u'nflrcapp_taggeditem', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nflrcapp.ItemTag']))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'TaggedItem.tag' to match new field type.
        db.rename_column(u'nflrcapp_taggeditem', 'tag_id', 'tag')
        # Changing field 'TaggedItem.tag'
        db.alter_column(u'nflrcapp_taggeditem', 'tag', self.gf('django.db.models.fields.SlugField')(max_length=50))
