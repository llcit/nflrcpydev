...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nflrcapp_contactrole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'nflrcapp', ['ContactRole'])

        # Adding field 'Contact.staff_role'
        db.add_column(u'nflrcapp_contact', 'staff_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nflrcapp.ContactRole'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ContactRole'
        db.delete_table(u'nflrcapp_contactrole')

        # Deleting field 'Contact.staff_role'
        db.delete_column(u'nflrcapp_contact', 'staff_role_id')
