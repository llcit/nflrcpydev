...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'nflrcapp_taggeditem', 'tag_id')

        # Adding field 'TaggedItem.item_tag'
        db.add_column(u'nflrcapp_taggeditem', 'item_tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['nflrcapp.ItemTag']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaggedItem.tag'
        db.add_column(u'nflrcapp_taggeditem', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='blank', to=orm['nflrcapp.ItemTag']),
                      keep_default=False)

        # Deleting field 'TaggedItem.item_tag'
        db.delete_column(u'nflrcapp_taggeditem', 'item_tag_id')
    ...
    models = {
        ...
        u'nflrcapp.taggeditem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nflrcapp.ItemTag']"}),
