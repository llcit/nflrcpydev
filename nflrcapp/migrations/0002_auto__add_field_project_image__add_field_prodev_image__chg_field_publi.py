...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nflrcapp_project', 'image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100L, blank=True),
                      keep_default=False)

        # Adding field 'Prodev.image'
        db.add_column(u'nflrcapp_prodev', 'image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100L, blank=True),
                      keep_default=False)


        # Changing field 'Publication.isbn'
        db.alter_column(u'nflrcapp_publication', 'isbn', self.gf('django.db.models.fields.CharField')(max_length=20L, null=True))
        # Adding field 'Contact.image'
        db.add_column(u'nflrcapp_contact', 'image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100L, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'nflrcapp_project', 'image')

        # Deleting field 'Prodev.image'
        db.delete_column(u'nflrcapp_prodev', 'image')


        # Changing field 'Publication.isbn'
        db.alter_column(u'nflrcapp_publication', 'isbn', self.gf('django.db.models.fields.CharField')(default='', max_length=20L))
        # Deleting field 'Contact.image'
        db.delete_column(u'nflrcapp_contact', 'image')
