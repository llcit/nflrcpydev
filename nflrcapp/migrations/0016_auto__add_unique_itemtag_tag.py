...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ItemTag', fields ['tag']
        db.create_unique(u'nflrcapp_itemtag', ['tag'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemTag', fields ['tag']
        db.delete_unique(u'nflrcapp_itemtag', ['tag'])
