...
class Prodev(models.Model):
    ...
    def properties(self):
        properties = [(field.name, field.value_to_string(self)) for field in Prodev._meta.fields]
        return properties
...
class Publication(models.Model):
    ...
    category = models.CharField(max_length=128, choices=PUBLICATION_MEDIA_TYPES)
    ...
    def properties(self):
        properties = [(field.name, field.value_to_string(self)) for field in Publication._meta.fields]
        return properties
